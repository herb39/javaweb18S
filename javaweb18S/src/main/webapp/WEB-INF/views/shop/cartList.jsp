  ...
  <script>
    ...
    function onTotal(){
      ...
      if(total>=50000||total==0){
        ...
        document.getElementById("delivery").value=2500;
      }
      let lastPrice=parseInt(document.getElementById("delivery").value)+total;
    ...
    function order(){
        ...
        document.myform.delivery.value=document.getElementById("delivery").value;
...
<div class="container">
		...
		<table class="table-bordered text-center" style="margin: auto; width:90%">
		  ...
		  <c:forEach var="listVO" items="${cartListVOS}">
		    <tr align="center">
		      ...
		      <td><a href="${ctp}/shop/productContent?idx=${listVO.productIdx}"><img src="${ctp}/shop/product/${listVO.thumbImg}" width="150px"/></a></td>
		      <td align="left">
		        <p class="contFont"><br/>
		          상품명 : <span style="color:orange;font-weight:bold;"><a href="${ctp}/shop/productContent?idx=${listVO.productIdx}">${listVO.productName}</a></span><br/>
  ...
  <p class="text-center">
    <b>실제 주문총금액</b>(구매하실 상품에 체크해 주세요.)<br/>
    5만원 이상 구매시 배송비 무료입니다.
  </p>
	<table class="table-borderless text-center" style="margin:auto">
	  ...
	  <tr>
	    ...
	    <td>+</td>
	    <td><input type="text" id="delivery" value="0" class="totSubBox" readonly/></td>
	    <td>=</td>
	...
	<div class="text-center">
	  ...
	  <button class="btn btn-dark" onClick="location.href='${ctp}/shop/productList';">계속 쇼핑하기</button>
	</div>
</div>
<p><br/></p>
