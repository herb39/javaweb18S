...
<div class="container">
  <span>[<a href="${ctp}/shop/productList">전체보기</a>]</span> /
  <c:forEach var="productTitle" items="${productTitleVOS}" varStatus="st">
  	<span>[<a href="${ctp}/shop/productList?part=${productTitle.categoryArtistName}">${productTitle.categoryArtistName}</a>]</span>
  ...
  <div class="row">
    ...
    <div class="col text-right">
		  <button type="button" class="btn btn-dark" onclick="location.href='${ctp}/shop/cartList';">장바구니</button>
    </div>
  </div>
  <hr/>
  ...
  <div class="row mt-4">
    ...
    <div class="container">
      <c:if test="${fn:length(productVOS) == 0}"><h3>상품 준비 중입니다.</h3></c:if>
    </div>
  </div>
  <hr/>
