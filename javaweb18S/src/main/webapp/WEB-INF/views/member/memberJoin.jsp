...
<body>
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" name="joinForm" id="joinForm" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label for="mid">아이디<font color="red">*</font> &nbsp; &nbsp;
					<input type="button" value="아이디 중복확인" id="midBtn" class="btn btn-dark btn-sm" onclick="idCheck()" /></label>
				...
				<div class="wrap-input100 validate-input m-b-25">
					<input class="input100" type="text" name="name" id="name" placeholder="성명" required />
					<span class="focus-input100"></span>
				</div>
				<label for="nickName">닉네임<font color="red">*</font> &nbsp; &nbsp;
				<input type="button" value="닉네임 중복확인" id="nickNameBtn" class="btn btn-dark btn-sm" onclick="nickNameCheck()" /></label>
				<div class="wrap-input100 validate-input m-b-25">
					<input class="input100" type="text" name="nickName" id="nickName" placeholder="닉네임" required />
					<span class="focus-input100"></span>
				</div>
				<label for="tel">전화번호<font color="red">*</font></label>
				<div class="wrap-input100 validate-input m-b-25">
					<input class="input100" type="text" name="tel" id="tel" placeholder="전화번호 (숫자만 입력)" required />
					<span class="focus-input100"></span>
				</div>
				...
				<div class="text-center">
					<a href="${ctp}/member/memberLogin" class="txt2 hov1">
						로 그 인
					</a>
				</div>
			</form>
	...
	<script>
		...
		function fCheck() {
			...
			/* // 사진 업로드 체크 준비
			let maxSize = 1024 * 1024 * 2;	// 업로드 할 회원사진 용량 2MB 제한
			let fName = joinForm.fName.value;
			let ext = fName.substring(fName.lastIndexOf(".")+1).toUpperCase();	// 파일 확장자 발췌 후 대문자로 변환 */
			...
			if (submitFlag == 1) {
				...
				alert("회원가입에 실패했습니다. 형식을 다시 확인하세요.");
			}
		}
