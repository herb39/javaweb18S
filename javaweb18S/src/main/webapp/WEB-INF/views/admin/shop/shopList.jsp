...
<p><br/></p>
<div class="container">
  <span>[<a href="${ctp}/shop/shopList">전체보기</a>]</span> /
  <c:forEach var="productTitle" items="${productTitleVOS}" varStatus="st">
  	<span>[<a href="${ctp}/shop/shopList?part=${productTitle.categoryArtistName}">${productTitle.categoryArtistName}</a>]</span>
  ...
  <div class="row">
    ...
    <div class="col text-right">
		  <button type="button" class="btn btn-dark" onclick="location.href='${ctp}/shop/product';">상품등록</button>
    </div>
  </div>
  <hr/>
