...
<head>
  ...
  <script>
    ...
    function productDelete() {
    	let ans = confirm("해당 상품을 삭제하시겠습니까?");
    	if(ans) location.href="${ctp}/shop/productDelete?idx=${productVO.idx}";
    }
  </script>
</head>
<body>
...
<div class="container">
  <div class="row">
    <div class="col p-3 text-center" style="border:1px solid #ccc">
		  <!-- 상품메인 이미지 -->
		  <div>
		    <img src="${ctp}/shop/product/${productVO.FSName}" width="100%"/>
		  </div>
		</div>
		<div class="col p-3 text-right">
		  ...
		  <div class="text-right p-2">
		    <button type="button" onclick="productDelete()" class="btn btn-dark">상품삭제</button>
		    <input type="button" value="옵션등록" onclick="location.href='${ctp}/shop/option';" class="btn btn-dark"/>
		    <input type="button" value="목록" onclick="location.href='${ctp}/shop/shopList';" class="btn btn-dark"/>
		  </div>
		</div>
  </div>
  <br/><br/>
