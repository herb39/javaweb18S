...
<div class="container">
  <h2>상품에 따른 옵션 등록</h2>
  <hr/>
  <form name="myform" method="post" action="${ctp}/shop/option">
    <div class="product1">
      <p>-중분류명 : ${vo.categoryArtistName}</p>
      <p>-소분류명 : ${vo.categoryProductName}</p>
      ...
      <p><a href="${ctp}/shop/shopContent?idx=${vo.idx}" class="btn btn-success">돌아가기</a></p>
    </div>
    <div class="product2">
      <p><img src="${ctp}/shop/product/${vo.FSName}" width="80%"/></p>
    </div>
    <div class="product3">
	    <hr/>
