...
insert into s_board values (default,'admin','대장','게시판 오픈!!','herb_39@nate.com','첫 게시글이다ㅏㅏㅏㅏㅏㅏ','192.168.0.58',default);

select * from board2;

/* 게시판에 댓글 달기 */
create table s_boardReply (
  ...
  foreign key(boardIdx) references s_board(idx)	/* 외래키 설정 */
  on update cascade
  on delete restrict
);
